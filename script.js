...
const I18N = {
  ...
  ca: {
    ...
    "local.doorWaitAria": "Ampliar foto de la zona d'espera al costat de l'entrada",
    "local.doorWaitAlt": "Zona d'espera al costat de l'entrada",
    "local.doorAria": "Ampliar foto de l'entrada",
    "local.doorAlt": "Entrada lluminosa de Rayo Washing",
